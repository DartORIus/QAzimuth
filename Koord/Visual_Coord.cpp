...
void Visual_Coord::animate(const struct GPGGA &GPGGA)
{
    if(GPGGA.observation != 0)
    {
        Koord.Lat_List .push_back(GPGGA.latitude);
        Koord.Long_List.push_back(GPGGA.longitude);
